...
Gabrielle Vincenza T. Tongol - 12177954 - S21A
...
int main()
{
    ...
    int cStartGame = 1;    // used to loop the game
    ...
    do
    {
        ...
        if (nChoice == 4 || nWordCnt >= 15 || p[num].score < 0)
        {
            ...
            i = 0; // initialize to 0 again for the game loop
            ...
            j = 0; // initialize to 0 again for the game loop
